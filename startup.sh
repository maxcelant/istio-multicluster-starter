...
both_context "kubectl rollout status deploy -n cert-manager cert-manager-webhook"
both_context "kubectl rollout status deploy -n cert-manager cert-manager-cainjector"
both_context "kubectl rollout status deploy -n cert-manager cert-manager"
