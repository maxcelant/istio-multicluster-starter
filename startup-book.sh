...
istioctl install --context="kind-east-cluster" -y -f book/gateways/east-gw.yaml
istioctl install --context="kind-west-cluster" -y -f book/gateways/west-gw.yaml

kwest apply -n istio-system -f book/gateways/expose-services.yaml
keast apply -n istio-system -f book/gateways/expose-services.yaml